...
"""
This uses Strassen's algorithm described in Section 4.2
of CLRS. pg 79. 

Instead of performing 8 recursions of n/2 x n/2 matrices, 
we perform just seven. 

In the big order of things, this stakes theta(n^3)
